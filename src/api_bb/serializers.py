...
class MusicaSerializer(serializers.ModelSerializer):
    """Serializer simples para o MusicaViewSet."""
    class Meta:
        model = Musica
        fields = '__all__'
...
class AvaliacaoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Avaliacao
        fields = ("id", "comentario", "data_avaliacao", "nota", "avaliador", "musica")
    ...
    def validate(self, data):
        ...
        if request and hasattr(request, 'user'):
            ...
            if Avaliacao.objects.filter(musica=musica, avaliador=user).exists():
